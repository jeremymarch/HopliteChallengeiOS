...
Verb verbs[NUM_VERBS] = {
    ...
    { 81, PREFIXED, 12, "προδίδωμι", "προδώσω", "προέδωκα, προύδωκα", "προδέδωκα", "προδέδομαι", "προεδόθην, προυδόθην" },
    { 82, 0, 16, "φημί", "φήσω", "ἔφησα", "", "", "" },
    
    { 83, 0, 17, "ἁμαρτάνω", "ἁμαρτήσομαι", "ἥμαρτον", "ἡμάρτηκα", "ἡμάρτημαι", "ἡμαρτήθην" },
    { 84, CONSONANT_STEM_PERFECT_KAPPA, 17, "δοκέω", "δόξω", "ἔδοξα", "", "δέδογμαι", "-ἐδόχθην" },
    { 85, 0, 17, "δύναμαι", "δυνήσομαι", "", "", "δεδύνημαι", "ἐδυνήθην" },
    { 86, 0, 17, "εἶμι", "", "", "", "", "" },
    
    { 87, CONTRACTED_FUTURE_ALPHA, 17, "ἐλαύνω", "ἐλῶ", "ἤλασα", "-ἐλήλακα", "ἐλήλαμαι", "ἠλάθην" },
    { 88, 0, 17, "ἐπίσταμαι", "ἐπιστήσομαι", "", "", "", "ἠπιστήθην" },
    { 89, 0, 17, "ἔχω", "ἕξω, σχήσω", "ἔσχον", "ἔσχηκα", "-ἔσχημαι", "" },
    
    { 90, PREFIXED, 18, "ἀποθνῄσκω", "ἀποθανοῦμαι", "ἀπέθανον", "τέθνηκα", "", "" },
    { 91, PREFIXED, 18, "ἀποκτείνω", "ἀποκτενῶ", "ἀπέκτεινα", "ἀπέκτονα", "", "" },
    { 92, PREFIXED, 18, "ἀφῑ́ημι", "ἀφήσω", "ἀφῆκα", "ἀφεῖκα", "ἀφεῖμαι", "ἀφείθην" },
    { 93, 0, 18, "βουλεύω", "βουλεύσω", "ἐβούλευσα", "βεβούλευκα", "βεβούλευμαι", "ἐβουλεύθην" },
    { 94, 0, 18, "ζητέω", "ζητήσω", "ἐζήτησα", "ἐζήτηκα", "", "ἐζητήθην" },
    { 95, 0, 18, "ῑ̔́ημι", "-ἥσω", "-ἧκα", "-εἷκα", "-εἷμαι", "-εἵθην" },
    { 96, 0, 18, "μέλλω", "μελλήσω", "ἐμέλλησα", "", "", "" },
    { 97, 0, 18, "πιστεύω", "πιστεύσω", "ἐπίστευσα", "πεπίστευκα", "πεπίστευμαι", "ἐπιστεύθην" },
    { 98, PREFIXED, 18, "συνῑ́ημι", "συνήσω", "συνῆκα", "συνεῖκα", "συνεῖμαι", "συνείθην" },
    
    { 99, CONSONANT_STEM_PERFECT_NU, 19, "αἰσχῡ́νομαι", "αἰσχυνοῦμαι", "", "", "ᾔσχυμμαι", "ᾐσχύνθην" },
    { 100, PREFIXED, 19, "ἀποκρῑ́νομαι", "ἀποκρινοῦμαι", "ἀπεκρῑνάμην", "", "ἀποκέκριμαι", "" },
    { 101, PREFIXED, 19, "ἀπόλλῡμι", "ἀπολῶ", "ἀπώλεσα, ἀπωλόμην", "ἀπολώλεκα, ἀπόλωλα", "", "" },
    
    /* MISSING ANERHSOMAI */
    { 102, PREFIXED, 19, "", "ἀνερήσομαι", "ἀνηρόμην", "", "", "" },
    { 103, 0, 19, "", "ἐρήσομαι", "ἠρόμην", "", "", "" },
    { 104, 0, 19, "εὑρίσκω", "εὑρήσω", "ηὗρον", "ηὗρηκα", "ηὕρημαι", "ηὑρέθην" },
    { 105, 0, 19, "ἡγέομαι", "ἡγήσομαι", "ἡγησάμην", "", "ἥγημαι", "ἡγήθην" },
    { 106, 0, 19, "κρῑ́νω", "κρινῶ", "ἔκρῑνα", "κέκρικα", "κέκριμαι", "ἐκρίθην" },
    { 107, 0, 19, "οἶδα", "εἴσομαι", "", "", "", "" },
    { 108, PREFIXED, 19, "σύνοιδα", "συνείσομαι", "", "", "", "" },
    
    { 109, CONSONANT_STEM_PERFECT_KAPPA | PREFIXED, 20, "ἀφικνέομαι", "ἀφίξομαι", "ἀφῑκόμην", "", "ἀφῖγμαι", "" },
    { 110, 0, 20, "δεῖ", "δεήσει", "ἐδέησε(ν)", "", "", "" },
    { 111, 0, 20, "κεῖμαι", "κείσομαι", "", "", "", "" },
    { 112, CONSONANT_STEM_PERFECT_SIGMA, 20, "πυνθάνομαι", "πεύσομαι", "ἐπυθόμην", "", "πέπυσμαι", "" },
    { 113, CONSONANT_STEM_PERFECT_PI, 20, "τρέπω", "τρέψω", "ἔτρεψα, ἐτραπόμην", "τέτροφα", "τέτραμμαι", "ἐτράπην, ἐτρέφθην" },
    { 114, CONSONANT_STEM_PERFECT_NU, 20, "φαίνω", "φανῶ", "ἔφηνα", "πέφηνα", "πέφασμαι", "ἐφάνην" },
    { 115, 0, 20, "χρή", "χρῆσται", "", "", "", "" }
};
