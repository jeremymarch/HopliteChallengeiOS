...
Verb verbs[NUM_VERBS] = {
    ...
    { 42, PREFIXED, 12, "ἀνατίθημι", "ἀναθήσω", "ἀνέθηκα", "ἀνατέθηκα", "ἀνατέθειμαι", "ἀνετέθην" },
    { 43, PREFIXED, 12, "ἀποδίδωμι", "ἀποδώσω", "ἀπέδωκα", "ἀποδέδωκα", "ἀποδέδομαι", "ἀπεδόθην" },
    { 44, PREFIXED, 12, "ἀφίστημι", "ἀποστήσω", "ἀπέστησα, ἀπέστην", "ἀφέστηκα", "ἀφέσταμαι", "ἀπεστάθην" },
    { 45, 0, 12, "δίδωμι", "δώσω", "ἔδωκα", "δέδωκα", "δέδομαι", "ἐδόθην" },
    { 46, 0, 12, "ἵστημι", "στήσω", "ἔστησα, ἔστην", "ἕστηκα", "ἕσταμαι", "ἐστάθην" },
    { 47, PREFIXED, 12, "καθίστημι", "καταστήσω", "κατέστησα, κατέστην", "καθέστηκα", "καθέσταμαι", "κατεστάθην" },
    { 48, PREFIXED, 12, "καταλῡ́ω", "καταλῡ́σω", "κατέλῡσα", "καταλέλυκα", "καταλέλυμαι", "κατελύθην" },
    { 49, 0, 12, "τίθημι", "θήσω", "ἔθηκα", "τέθηκα", "τέθειμαι", "ἐτέθην" },
    { 50, 0, 12, "φιλέω", "φιλήσω", "ἐφίλησα", "πεφίληκα", "πεφίλημαι", "ἐφιλήθην" },
    { 51, 0, 12, "φοβέομαι", "φοβήσομαι", "", "", "πεφόβημαι", "ἐφοβήθην" },
    
    { 52, 0, 13, "γίγνομαι", "γενήσομαι", "ἐγενόμην", "γέγονα", "γεγένημαι", "" },
    { 53, 0, 13, "ἔρχομαι", "ἐλεύσομαι", "ἦλθον", "ἐλήλυθα", "", "" },
    { 54, 0, 13, "μανθάνω", "μαθήσομαι", "ἔμαθον", "μεμάθηκα", "", "" }, //LSJ: Pass., used by good writers only in pres
    { 55, 0, 13, "μάχομαι", "μαχοῦμαι", "ἐμαχεσάμην", "", "μεμάχημαι", "" },
    { 56, PREFIXED, 13, "μεταδίδωμι", "μεταδώσω", "μετέδωκα", "μεταδέδωκα", "μεταδέδομαι", "μετεδόθην" },
    { 57, PREFIXED, 13, "μετανίσταμαι", "μεταναστήσομαι", "μετανέστην", "μετανέστηκα", "", "" },
    { 58, 0, 13, "μηχανάομαι", "μηχανήσομαι", "ἐμηχανησάμην", "", "μεμηχάνημαι", "" },
    { 59, 0, 13, "φεύγω", "φεύξομαι", "ἔφυγον", "πέφευγα", "", "" },
    
    { 60, CONSONANT_STEM_PERFECT_KAPPA, 14, "δείκνῡμι", "δείξω", "ἔδειξα", "δέδειχα", "δέδειγμαι", "ἐδείχθην" },
    { 61, PREFIXED, 14, "ἐπανίσταμαι", "ἐπαναστήσομαι", "ἐπανέστην", "ἐπανέστηκα", "", "" },
    { 62, CONSONANT_STEM_PERFECT_KAPPA | PREFIXED, 14, "ἐπιδείκνυμαι", "ἐπιδείξομαι", "ἐπεδειξάμην", "", "ἐπιδέδειγμαι", "" },
    { 63, 0, 14, "ἐρωτάω", "ἐρωτήσω", "ἠρώτησα", "ἠρώτηκα", "ἠρώτημαι", "ἠρωτήθην" },
    { 64, 0, 14, "λανθάνω", "λήσω", "ἔλαθον", "λέληθα", "", "" },
    { 65, PREFIXED, 14, "παραγίγνομαι", "παραγενήσομαι", "παρεγενόμην", "παραγέγονα", "παραγεγένημαι", "" },
    { 66, PREFIXED, 14, "παραδίδωμι", "παραδώσω", "παρέδωκα", "παραδέδωκα", "παραδέδομαι", "παρεδόθην" },
    { 67, PREFIXED, 14, "παραμένω", "παραμενῶ", "παρέμεινα", "παραμεμένηκα", "", "" },
    { 68, 0, 14, "τυγχάνω", "τεύξομαι", "ἔτυχον", "τετύχηκα", "", "" },
    { 69, PREFIXED, 14, "ὑπακούω", "ὑπακούσομαι", "ὑπήκουσα", "ὑπακήκοα", "", "ὑπηκούσθην" },
    { 70, PREFIXED, 14, "ὑπομένω", "ὑπομενῶ", "ὑπέμεινα", "ὑπομεμένηκα", "", "" },
    { 71, 0, 14, "φθάνω", "φθήσομαι", "ἔφθασα, ἔφθην", "", "", "" },
    { 72, 0, 14, "χαίρω", "χαιρήσω", "", "κεχάρηκα", "", "ἐχάρην" },
    
    { 73, 0, 15, "αἱρέω", "αἱρήσω", "εἷλον", "ᾕρηκα", "ᾕρημαι", "ᾑρέθην" },
    { 74, 0, 15, "αἰσθάνομαι", "αἰσθήσομαι", "ᾐσθόμην", "", "ᾔσθημαι", "" },
    { 75, CONSONANT_STEM_PERFECT_KAPPA | PREFIXED, 15, "διαφέρω", "διοίσω", "διήνεγκα, διήνεγκον", "διενήνοχα", "διενήνεγμαι", "διηνέχθην" },
    { 76, 0, 15, "εἰμί", "ἔσομαι", "", "", "", "" },
    { 77, 0, 15, "ἕπομαι", "ἕψομαι", "ἑσπόμην", "", "", "" },
    { 78, CONSONANT_STEM_PERFECT_PI, 15, "ὁράω", "ὄψομαι", "εἶδον", "ἑόρᾱκα, ἑώρᾱκα", "ἑώρᾱμαι, ὦμμαι", "ὤφθην" },
    { 79, CONSONANT_STEM_PERFECT_KAPPA | PREFIXED, 15, "συμφέρω", "συνοίσω", "συνήνεγκα, συνήνεγκον", "συνενήνοχα", "συνενήνεγμαι", "συνηνέχθην" },
    { 80, CONSONANT_STEM_PERFECT_KAPPA, 15, "φέρω", "οἴσω", "ἤνεγκα, ἤνεγκον", "ἐνήνοχα", "ἐνήνεγμαι", "ἠνέχθην" },
    
    { 81, PREFIXED, 16, "ἀναβαίνω", "ἀναβήσομαι", "ἀνέβην", "ἀναβέβηκα", "", "" },
    { 82, 0, 16, "βαίνω", "-βήσομαι", "-ἔβην", "βέβηκα", "", "" },
    { 83, CONSONANT_STEM_PERFECT_SIGMA, 16, "γιγνώσκω", "γνώσομαι", "ἔγνων", "ἔγνωκα", "ἔγνωσμαι", "ἐγνώσθην" },
    { 84, PREFIXED, 16, "ἐκπῑ́πτω", "ἐκπεσοῦμαι", "ἐξέπεσον", "ἐκπέπτωκα", "", "" },
    { 85, CONSONANT_STEM_PERFECT_GAMMA, 16, "λέγω", "ἐρῶ, λέξω", "εἶπον, ἔλεξα", "εἴρηκα", "εἴρημαι, λέλεγμαι", "ἐλέχθην, ἐρρήθην" },
    { 86, CONSONANT_STEM_PERFECT_SIGMA, 16, "νομίζω", "νομιῶ", "ἐνόμισα", "νενόμικα", "νενόμισμαι", "ἐνομίσθην" },
    { 87, 0, 16, "πῑ́πτω", "πεσοῦμαι", "ἔπεσον", "πέπτωκα", "", "" },
    { 88, PREFIXED, 12, "προδίδωμι", "προδώσω", "προέδωκα, προύδωκα", "προδέδωκα", "προδέδομαι", "προεδόθην, προυδόθην" },
    { 89, 0, 16, "φημί", "φήσω", "ἔφησα", "", "", "" },
    
    { 90, 0, 17, "ἁμαρτάνω", "ἁμαρτήσομαι", "ἥμαρτον", "ἡμάρτηκα", "ἡμάρτημαι", "ἡμαρτήθην" },
    { 91, CONSONANT_STEM_PERFECT_KAPPA, 17, "δοκέω", "δόξω", "ἔδοξα", "", "δέδογμαι", "-ἐδόχθην" },
    { 92, 0, 17, "δύναμαι", "δυνήσομαι", "", "", "δεδύνημαι", "ἐδυνήθην" },
    { 93, 0, 17, "εἶμι", "", "", "", "", "" },
    
    { 94, CONTRACTED_FUTURE_ALPHA, 17, "ἐλαύνω", "ἐλῶ", "ἤλασα", "-ἐλήλακα", "ἐλήλαμαι", "ἠλάθην" },
    { 95, 0, 17, "ἐπίσταμαι", "ἐπιστήσομαι", "", "", "", "ἠπιστήθην" },
    { 96, 0, 17, "ἔχω", "ἕξω, σχήσω", "ἔσχον", "ἔσχηκα", "-ἔσχημαι", "" },
    
    { 97, PREFIXED, 18, "ἀποθνῄσκω", "ἀποθανοῦμαι", "ἀπέθανον", "τέθνηκα", "", "" },
    { 98, PREFIXED, 18, "ἀποκτείνω", "ἀποκτενῶ", "ἀπέκτεινα", "ἀπέκτονα", "", "" },
    { 99, PREFIXED, 18, "ἀφῑ́ημι", "ἀφήσω", "ἀφῆκα", "ἀφεῖκα", "ἀφεῖμαι", "ἀφείθην" },
    { 100, 0, 18, "βουλεύω", "βουλεύσω", "ἐβούλευσα", "βεβούλευκα", "βεβούλευμαι", "ἐβουλεύθην" },
    { 101, PREFIXED, 18, "ἐπιβουλεύω", "ἐπιβουλεύσω", "ἐπεβούλευσα", "ἐπιβεβούλευκα", "ἐπιβεβούλευμαι", "ἐπεβουλεύθην" },
    { 102, 0, 18, "ζητέω", "ζητήσω", "ἐζήτησα", "ἐζήτηκα", "", "ἐζητήθην" },
    { 103, 0, 18, "ῑ̔́ημι", "-ἥσω", "-ἧκα", "-εἷκα", "-εἷμαι", "-εἵθην" },
    { 104, 0, 18, "μέλλω", "μελλήσω", "ἐμέλλησα", "", "", "" },
    { 105, 0, 18, "πιστεύω", "πιστεύσω", "ἐπίστευσα", "πεπίστευκα", "πεπίστευμαι", "ἐπιστεύθην" },
    { 106, PREFIXED, 18, "συμβουλεύω", "συμβουλεύσω", "συνεβούλευσα", "συμβεβούλευκα", "συμβεβούλευμαι", "συνεβουλεύθην" },
    { 107, PREFIXED, 18, "συνῑ́ημι", "συνήσω", "συνῆκα", "συνεῖκα", "συνεῖμαι", "συνείθην" },
    
    { 108, CONSONANT_STEM_PERFECT_NU, 19, "αἰσχῡ́νομαι", "αἰσχυνοῦμαι", "", "", "ᾔσχυμμαι", "ᾐσχύνθην" },
    { 109, PREFIXED, 19, "ἀποκρῑ́νομαι", "ἀποκρινοῦμαι", "ἀπεκρῑνάμην", "", "ἀποκέκριμαι", "" },
    { 110, PREFIXED, 19, "ἀπόλλῡμι", "ἀπολῶ", "ἀπώλεσα, ἀπωλόμην", "ἀπολώλεκα, ἀπόλωλα", "", "" },
    
    { 111, PREFIXED, 19, "", "ἀνερήσομαι", "ἀνηρόμην", "", "", "" },
    { 112, 0, 19, "", "ἐρήσομαι", "ἠρόμην", "", "", "" },
    { 113, 0, 19, "εὑρίσκω", "εὑρήσω", "ηὗρον", "ηὗρηκα", "ηὕρημαι", "ηὑρέθην" },
    { 114, 0, 19, "ἡγέομαι", "ἡγήσομαι", "ἡγησάμην", "", "ἥγημαι", "ἡγήθην" },
    { 115, 0, 19, "κρῑ́νω", "κρινῶ", "ἔκρῑνα", "κέκρικα", "κέκριμαι", "ἐκρίθην" },
    { 116, 0, 19, "οἶδα", "εἴσομαι", "", "", "", "" },
    { 117, PREFIXED, 19, "σύνοιδα", "συνείσομαι", "", "", "", "" },
    
    { 118, CONSONANT_STEM_PERFECT_KAPPA | PREFIXED, 20, "ἀφικνέομαι", "ἀφίξομαι", "ἀφῑκόμην", "", "ἀφῖγμαι", "" },
    { 119, 0, 20, "δεῖ", "δεήσει", "ἐδέησε(ν)", "", "", "" },
    { 120, 0, 20, "κεῖμαι", "κείσομαι", "", "", "", "" },
    { 121, CONSONANT_STEM_PERFECT_SIGMA, 20, "πυνθάνομαι", "πεύσομαι", "ἐπυθόμην", "", "πέπυσμαι", "" },
    { 122, CONSONANT_STEM_PERFECT_PI, 20, "τρέπω", "τρέψω", "ἔτρεψα, ἐτραπόμην", "τέτροφα", "τέτραμμαι", "ἐτράπην, ἐτρέφθην" },
    { 123, CONSONANT_STEM_PERFECT_NU, 20, "φαίνω", "φανῶ", "ἔφηνα", "πέφηνα", "πέφασμαι", "ἐφάνην" },
    { 124, 0, 20, "χρή", "χρῆσται", "", "", "", "" }
};
