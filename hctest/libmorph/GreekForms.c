...
Verb verbs[NUM_VERBS] = {
    ...
    { 3, PREFIXED, 12, "καταλῡ́ω", "καταλῡ́σω", "κατέλῡσα", "καταλέλυκα", "καταλέλυμαι", "κατελύθην" },
    { 48, 0, 12, "τίθημι", "θήσω", "ἔθηκα", "τέθηκα", "τέθειμαι", "ἐτέθην" },
    { 49, 0, 12, "φιλέω", "φιλήσω", "ἐφίλησα", "πεφίληκα", "πεφίλημαι", "ἐφιλήθην" },
    { 50, 0, 12, "φοβέομαι", "φοβήσομαι", "", "", "πεφόβημαι", "ἐφοβήθην" },
    
    { 51, 0, 13, "γίγνομαι", "γενήσομαι", "ἐγενόμην", "γέγονα", "γεγένημαι", "" },
    { 52, 0, 13, "ἔρχομαι", "ἐλεύσομαι", "ἦλθον", "ἐλήλυθα", "", "" },
    { 53, 0, 13, "μανθάνω", "μαθήσομαι", "ἔμαθον", "μεμάθηκα", "", "" },
    { 54, 0, 13, "μάχομαι", "μαχοῦμαι", "ἐμαχεσάμην", "", "μεμάχημαι", "" },
    { 55, PREFIXED, 13, "μεταδίδωμι", "μεταδώσω", "μετέδωκα", "μεταδέδωκα", "μεταδέδομαι", "μετεδόθην" },
    { 56, PREFIXED, 13, "μετανίσταμαι", "μεταναστήσομαι", "μετανέστην", "μετανέστηκα", "", "" },
    { 57, 0, 13, "μηχανάομαι", "μηχανήσομαι", "ἐμηχανησάμην", "", "μεμηχάνημαι", "" },
    { 58, 0, 13, "φεύγω", "φεύξομαι", "ἔφυγον", "πέφευγα", "", "" },
    
    { 59, CONSONANT_STEM_PERFECT_KAPPA, 14, "δείκνῡμι", "δείξω", "ἔδειξα", "δέδειχα", "δέδειγμαι", "ἐδείχθην" },
    { 60, PREFIXED, 14, "ἐπανίσταμαι", "ἐπαναστήσομαι", "ἐπανέστην", "ἐπανέστηκα", "", "" },
    { 61, CONSONANT_STEM_PERFECT_KAPPA | PREFIXED, 14, "ἐπιδείκνυμαι", "ἐπιδείξομαι", "ἐπεδειξάμην", "", "ἐπιδέδειγμαι", "" },
    { 62, 0, 14, "ἐρωτάω", "ἐρωτήσω", "ἠρώτησα", "ἠρώτηκα", "ἠρώτημαι", "ἠρωτήθην" },
    { 63, 0, 14, "λανθάνω", "λήσω", "ἔλαθον", "λέληθα", "", "" },
    { 51, PREFIXED, 14, "παραγίγνομαι", "παραγενήσομαι", "παρεγενόμην", "παραγέγονα", "παραγεγένημαι", "" },
    { 45, PREFIXED, 14, "παραδίδωμι", "παραδώσω", "παρέδωκα", "παραδέδωκα", "παραδέδομαι", "παρεδόθην" },
    { 33, PREFIXED, 14, "παραμένω", "παραμενῶ", "παρέμεινα", "παραμεμένηκα", "", "" },
    { 64, 0, 14, "τυγχάνω", "τεύξομαι", "ἔτυχον", "τετύχηκα", "", "" },
    { 35, PREFIXED, 14, "ὑπακούω", "ὑπακούσομαι", "ὑπήκουσα", "ὑπακήκοα", "", "ὑπηκούσθην" },
    { 33, PREFIXED, 14, "ὑπομένω", "ὑπομενῶ", "ὑπέμεινα", "ὑπομεμένηκα", "", "" },
    { 65, 0, 14, "φθάνω", "φθήσομαι", "ἔφθασα, ἔφθην", "", "", "" },
    { 66, 0, 14, "χαίρω", "χαιρήσω", "", "κεχάρηκα", "", "ἐχάρην" },
    
    { 67, 0, 15, "αἱρέω", "αἱρήσω", "εἷλον", "ᾕρηκα", "ᾕρημαι", "ᾑρέθην" },
    { 68, 0, 15, "αἰσθάνομαι", "αἰσθήσομαι", "ᾐσθόμην", "", "ᾔσθημαι", "" },
    { 69, CONSONANT_STEM_PERFECT_KAPPA | PREFIXED, 15, "διαφέρω", "διοίσω", "διήνεγκα, διήνεγκον", "διενήνοχα", "διενήνεγμαι", "διηνέχθην" },
    { 70, 0, 15, "εἰμί", "ἔσομαι", "", "", "", "" },
    { 71, 0, 15, "ἕπομαι", "ἕψομαι", "ἑσπόμην", "", "", "" },
    { 72, CONSONANT_STEM_PERFECT_PI, 15, "ὁράω", "ὄψομαι", "εἶδον", "ἑόρᾱκα, ἑώρᾱκα", "ἑώρᾱμαι, ὦμμαι", "ὤφθην" },
    { 73, CONSONANT_STEM_PERFECT_KAPPA | PREFIXED, 15, "συμφέρω", "συνοίσω", "συνήνεγκα, συνήνεγκον", "συνενήνοχα", "συνενήνεγμαι", "συνηνέχθην" },
    { 74, CONSONANT_STEM_PERFECT_KAPPA, 15, "φέρω", "οἴσω", "ἤνεγκα, ἤνεγκον", "ἐνήνοχα", "ἐνήνεγμαι", "ἠνέχθην" },
    
    { 75, PREFIXED, 16, "ἀναβαίνω", "ἀναβήσομαι", "ἀνέβην", "ἀναβέβηκα", "", "" },
    { 76, 0, 16, "βαίνω", "-βήσομαι", "-ἔβην", "βέβηκα", "", "" },
    { 77, CONSONANT_STEM_PERFECT_SIGMA, 16, "γιγνώσκω", "γνώσομαι", "ἔγνων", "ἔγνωκα", "ἔγνωσμαι", "ἐγνώσθην" },
    { 78, PREFIXED, 16, "ἐκπῑ́πτω", "ἐκπεσοῦμαι", "ἐξέπεσον", "ἐκπέπτωκα", "", "" },
    { 79, CONSONANT_STEM_PERFECT_GAMMA, 16, "λέγω", "ἐρῶ, λέξω", "εἶπον, ἔλεξα", "εἴρηκα", "εἴρημαι, λέλεγμαι", "ἐλέχθην, ἐρρήθην" },
    { 80, CONSONANT_STEM_PERFECT_SIGMA, 16, "νομίζω", "νομιῶ", "ἐνόμισα", "νενόμικα", "νενόμισμαι", "ἐνομίσθην" },
    { 81, 0, 16, "πῑ́πτω", "πεσοῦμαι", "ἔπεσον", "πέπτωκα", "", "" },
    { 82, PREFIXED, 12, "προδίδωμι", "προδώσω", "προέδωκα, προύδωκα", "προδέδωκα", "προδέδομαι", "προεδόθην, προυδόθην" },
    { 83, 0, 16, "φημί", "φήσω", "ἔφησα", "", "", "" },
    
    { 84, 0, 17, "ἁμαρτάνω", "ἁμαρτήσομαι", "ἥμαρτον", "ἡμάρτηκα", "ἡμάρτημαι", "ἡμαρτήθην" },
    { 85, CONSONANT_STEM_PERFECT_KAPPA, 17, "δοκέω", "δόξω", "ἔδοξα", "", "δέδογμαι", "-ἐδόχθην" },
    { 86, 0, 17, "δύναμαι", "δυνήσομαι", "", "", "δεδύνημαι", "ἐδυνήθην" },
    { 87, 0, 17, "εἶμι", "", "", "", "", "" },
    
    { 88, CONTRACTED_FUTURE_ALPHA, 17, "ἐλαύνω", "ἐλῶ", "ἤλασα", "-ἐλήλακα", "ἐλήλαμαι", "ἠλάθην" },
    { 89, 0, 17, "ἐπίσταμαι", "ἐπιστήσομαι", "", "", "", "ἠπιστήθην" },
    { 90, 0, 17, "ἔχω", "ἕξω, σχήσω", "ἔσχον", "ἔσχηκα", "-ἔσχημαι", "" },
    
    { 91, PREFIXED, 18, "ἀποθνῄσκω", "ἀποθανοῦμαι", "ἀπέθανον", "τέθνηκα", "", "" },
    { 92, PREFIXED, 18, "ἀποκτείνω", "ἀποκτενῶ", "ἀπέκτεινα", "ἀπέκτονα", "", "" },
    { 93, PREFIXED, 18, "ἀφῑ́ημι", "ἀφήσω", "ἀφῆκα", "ἀφεῖκα", "ἀφεῖμαι", "ἀφείθην" },
    { 94, 0, 18, "βουλεύω", "βουλεύσω", "ἐβούλευσα", "βεβούλευκα", "βεβούλευμαι", "ἐβουλεύθην" },
    { 94, PREFIXED, 18, "ἐπιβουλεύω", "ἐπιβουλεύσω", "ἐπεβούλευσα", "ἐπιβεβούλευκα", "ἐπιβεβούλευμαι", "ἐπεβουλεύθην" },
    { 95, 0, 18, "ζητέω", "ζητήσω", "ἐζήτησα", "ἐζήτηκα", "", "ἐζητήθην" },
    { 96, 0, 18, "ῑ̔́ημι", "-ἥσω", "-ἧκα", "-εἷκα", "-εἷμαι", "-εἵθην" },
    { 97, 0, 18, "μέλλω", "μελλήσω", "ἐμέλλησα", "", "", "" },
    { 98, 0, 18, "πιστεύω", "πιστεύσω", "ἐπίστευσα", "πεπίστευκα", "πεπίστευμαι", "ἐπιστεύθην" },
    { 94, PREFIXED, 18, "συμβουλεύω", "συμβουλεύσω", "συνεβούλευσα", "συμβεβούλευκα", "συμβεβούλευμαι", "συνεβουλεύθην" },
    { 99, PREFIXED, 18, "συνῑ́ημι", "συνήσω", "συνῆκα", "συνεῖκα", "συνεῖμαι", "συνείθην" },
    
    { 100, CONSONANT_STEM_PERFECT_NU, 19, "αἰσχῡ́νομαι", "αἰσχυνοῦμαι", "", "", "ᾔσχυμμαι", "ᾐσχύνθην" },
    { 101, PREFIXED, 19, "ἀποκρῑ́νομαι", "ἀποκρινοῦμαι", "ἀπεκρῑνάμην", "", "ἀποκέκριμαι", "" },
    { 102, PREFIXED, 19, "ἀπόλλῡμι", "ἀπολῶ", "ἀπώλεσα, ἀπωλόμην", "ἀπολώλεκα, ἀπόλωλα", "", "" },
    
    { 103, PREFIXED, 19, "", "ἀνερήσομαι", "ἀνηρόμην", "", "", "" },
    { 104, 0, 19, "", "ἐρήσομαι", "ἠρόμην", "", "", "" },
    { 105, 0, 19, "εὑρίσκω", "εὑρήσω", "ηὗρον", "ηὗρηκα", "ηὕρημαι", "ηὑρέθην" },
    { 106, 0, 19, "ἡγέομαι", "ἡγήσομαι", "ἡγησάμην", "", "ἥγημαι", "ἡγήθην" },
    { 107, 0, 19, "κρῑ́νω", "κρινῶ", "ἔκρῑνα", "κέκρικα", "κέκριμαι", "ἐκρίθην" },
    { 108, 0, 19, "οἶδα", "εἴσομαι", "", "", "", "" },
    { 109, PREFIXED, 19, "σύνοιδα", "συνείσομαι", "", "", "", "" },
    
    { 110, CONSONANT_STEM_PERFECT_KAPPA | PREFIXED, 20, "ἀφικνέομαι", "ἀφίξομαι", "ἀφῑκόμην", "", "ἀφῖγμαι", "" },
    { 111, 0, 20, "δεῖ", "δεήσει", "ἐδέησε(ν)", "", "", "" },
    { 112, 0, 20, "κεῖμαι", "κείσομαι", "", "", "", "" },
    { 113, CONSONANT_STEM_PERFECT_SIGMA, 20, "πυνθάνομαι", "πεύσομαι", "ἐπυθόμην", "", "πέπυσμαι", "" },
    { 114, CONSONANT_STEM_PERFECT_PI, 20, "τρέπω", "τρέψω", "ἔτρεψα, ἐτραπόμην", "τέτροφα", "τέτραμμαι", "ἐτράπην, ἐτρέφθην" },
    { 115, CONSONANT_STEM_PERFECT_NU, 20, "φαίνω", "φανῶ", "ἔφηνα", "πέφηνα", "πέφασμαι", "ἐφάνην" },
    { 116, 0, 20, "χρή", "χρῆσται", "", "", "", "" }
};
